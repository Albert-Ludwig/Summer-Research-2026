...
The work in this repository covers several key aspects of autonomous systems:

1.  **Autonomous Navigation**: Development of path-planning algorithms for robots in dynamic environments.
2.  **Control Systems**: Analysis and implementation of robust control laws for mobile platforms.
3.  **Space and Aerospace Robotics**: Exploring the application of autonomous control in specialized robotic environments.

## Repository Structure

- `/src`: Implementation of robotic controllers and navigation algorithms.
- `/simulations`: Simulation environments and test benches.
- `/data`: Logs and performance metrics from experimental runs.
- `/docs`: Technical reports and project presentations.

## Acknowledgments

I would like to express my gratitude to Dr. Stephen L. Smith for his mentorship and to the Rising Stars program leadership for their support throughout the summer research term.
