...
{
  // The Gazebo plugin can call this service before its actor list is ready.
  // Keep waiting instead of permanently initializing the manager with zero agents.
  if (request->current_agents.agents.empty())
  {
