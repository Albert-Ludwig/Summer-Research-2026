...
CONFIG_PATH = os.path.join(INFERENCE_REPO, "crowd_nav", "configs", "policy_test_mode.config")
ENV_CONFIG_PATH = os.path.join(INFERENCE_REPO, "crowd_nav", "configs", "env.config")
CKPT_PATH = os.path.join(INFERENCE_REPO, "ckpt_step990000_sogudiff_singleaxis_1p5M.pt")
NORM_PATH = os.path.join(INFERENCE_REPO, "norm_stats_sogudiff_allarms_1p5M.npy")
