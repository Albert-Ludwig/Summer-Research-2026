#!/usr/bin/env python3
"""
One-command launcher for the Humble SocialNavDiffusion + HuNav + Jackal
Gazebo test.

Run inside the ROS/Gazebo Humble container:
  python3 run_final_social_nav_test_humble.py

Useful options:
  python3 run_final_social_nav_test_humble.py
  python3 run_final_social_nav_test_humble.py --goal 1.0 0.0
  python3 run_final_social_nav_test_humble.py --no-rviz --goal 1.0 0.0
  python3 run_final_social_nav_test_humble.py --skip-cleanup

This starts HuNav/Gazebo Fortress, the clock bridge, simulated J100,
TF support, SLAM, the SocialNavDiffusion policy and goal bridge, and
optionally RViz. It does not send an automatic goal.
"""
