...
def main():
    ...
    if ax1 is not None:
        fig1.savefig("success_rate.png", dpi=300, bbox_inches="tight")

    if ax2 is not None:
        fig2.savefig("time.png", dpi=300, bbox_inches="tight")

    if ax3 is not None:
        fig3.savefig("collision_rate.png", dpi=300, bbox_inches="tight")

    if ax4 is not None:
        fig4.savefig("reward.png", dpi=300, bbox_inches="tight")
