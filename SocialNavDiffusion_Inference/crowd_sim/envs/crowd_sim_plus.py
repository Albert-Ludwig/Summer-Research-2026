...
from crowd_sim.envs.utils.utils import point_to_segment_dist, closest_point_on_segment, intersection_of_vec_line_and_2p_line, closest_point_on_segment_extended, check_point_on_line_seg, find_intersection_of_static_obstacles, closest_distance_between_line_segments
from crowd_sim.envs.utils.robot import get_vizable_robocentric
...
class CrowdSim(gym.Env):
    ...
    def render(self, mode='human', output_file=None, joint_state=None, debug=False):
        ...
        import subprocess
        ffmpeg_path = '/cvmfs/soft.computecanada.ca/easybuild/software/2023/x86-64-v3/Compiler/gcccore/ffmpeg/7.1.1/bin/ffmpeg'
