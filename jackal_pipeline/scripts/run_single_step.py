...
def main():
    ...
    ckpt = snd_root / "ckpt_step478000_SOCIAL_NORMS8.pt"
    norm = snd_root / "norm_stats_SOCIAL_NORMS8.npy"
    policy_config = snd_root / "crowd_nav/configs/policy.config"
